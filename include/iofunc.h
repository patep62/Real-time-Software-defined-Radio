...
void readData(const std::string, std::vector<float> &, std::vector<float> &, int);
void readStdinBlockData(unsigned int, unsigned int, std::vector<float> &, std::vector<float> &);
#endif // DY4_IOFUNC_H
