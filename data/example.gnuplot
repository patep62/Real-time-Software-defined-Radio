...
set xrange [100:250]                      # set x plot range
plot '../data/test.dat' using 1:2 with lines lt 1 lw 2 lc rgb '#000088' notitle

# freq domain (Fourier)
set ylabel 'Spectrum (Mag)'              # set y-axis label
set xlabel 'Frequency bin'               # set x-axis label
set yrange [0.0:0.25]                    # set y plot range
set xrange [900:1023]                       # set x plot range
...
set yrange [-180:0]                       # set y plot range
set xrange [0:119766]                       # set x plot range
# add your own .dat file for PSD as part of the take-home
#plot '../data/bandpass.dat' using 1:2 with lines lt 1 lw 3 lc rgb '#880000' notitle
